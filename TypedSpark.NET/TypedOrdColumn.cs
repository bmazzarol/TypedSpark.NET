...
namespace TypedSpark.NET
{
        ...
        where TSparkType : DataType
    {
        ...
        public BooleanColumn Gt(TNativeType rhs) =>
            BooleanColumn.New(ColumnName, Column.Gt(Lit(rhs)));
        ...
        public BooleanColumn Lt(TNativeType rhs) =>
            BooleanColumn.New(ColumnName, Column.Lt(Lit(rhs)));
